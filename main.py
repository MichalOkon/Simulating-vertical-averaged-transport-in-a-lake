...
# xy = sim.simulate()
convergence_analysis = conv.Convergence(n_particles=10000, dt=0.0001, x0=0.5, y0=0.5, t_end=1,
                                        scheme="Euler")
strong_error, weak_error, dt = convergence_analysis.estimate_convergence(100, 1)
