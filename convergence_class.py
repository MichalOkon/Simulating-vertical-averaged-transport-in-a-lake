...
class Convergence:
    ...
    def estimate_convergence(self, n_samples, dt_ratio):
        ...
        sim_accurate = sim.Sim(self.n_particles, self.dt * dt_ratio, self.x0, self.y0, self.t_end,
                               self.scheme, domain_behavior="clip")
        ...
        for i in range(0, n_samples):
            ...
            dummy_sim = sim.Sim(self.n_particles, dt, self.x0, self.y0, self.t_end, self.scheme, domain_behavior="clip")
            position_data, last_position, excluded_particles = dummy_sim.simulate()
